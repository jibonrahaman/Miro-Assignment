...
export default function BuilstFor() {
  return (
    ...
    <button className=' px-4 py-2 rounded-full bg-transparent hover:bg-gray-300 duration-700 border '>Sales</button>
      ...
      <Flex className='md:justify-between   flex-wrap pt-5'>
         <div className=' pt-10'>
         ...
         <div className='flex md:flex-none items-center md:items-start flex-col'>
         ...
         <Images src={builtFor} alt={builtFor} className='md:w-3/5'/>
      </Flex>
    </section>
  )
}
